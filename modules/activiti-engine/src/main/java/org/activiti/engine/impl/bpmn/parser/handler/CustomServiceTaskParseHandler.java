...
import org.activiti.engine.impl.bpmn.behavior.LiferayMailActivityBehavior;
	      ...
	      if (StringUtils.isNotEmpty(serviceTask.getType())) {
	    	  if (serviceTask.getType().equalsIgnoreCase("mail")) {
	    		  ...
	    		  if (abf instanceof AbstractBehaviorFactory) {
		    		  ...
		    		  activity.setActivityBehavior((LiferayMailActivityBehavior) ClassDelegate.defaultInstantiateDelegate(LiferayMailActivityBehavior.class, fieldDeclarations));
	    		  }
	    	  }
	      }
	}
